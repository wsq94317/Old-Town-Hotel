...
public static class GameText
{
    ...
    private static readonly Dictionary<string, string> Zh = new Dictionary<string, string>
    {
        ...
        { "DEBT ${0}   credit: {1}", "债务 ${0}   信用：{1}" },
        { "PAY THE BANK ${0}", "还银行 ${0}" },
        { "You skipped the bank {0}x. Interest is now higher.", "你已经 {0} 次没还银行。利息涨上去了。" },
        { "You skipped the bank once. A warning - next time it costs.", "你有一次没还银行。这次算警告——下次就要花钱了。" },
        ...
        { "GOOD - the bank likes you", "良好——银行喜欢你" },
        { "SHAKY - they are watching", "存疑——他们盯着你" },
        { "BAD - new money costs a fortune", "很差——想借新钱贵得离谱" },
        { "BLACKLISTED - nobody will lend to you", "已拉黑——没人再借给你" },
