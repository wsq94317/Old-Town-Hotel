...
public static class GameText
{
    ...
    private static readonly Table Zh = new Table
    {
        ...
        { "WRECKED", "已塌毁" },
        { "Tap a room in the hotel, then come back here to work on it.", "先在楼里点一间房，再回到这一页对它动手。" },
        { "Room {0} is a building site. Nothing to decide until it is done.", "{0} 房正在施工。完工之前没什么要决定的。" },
        { "DERELICT - two ways in", "破败房 —— 两条路" },
        { "Housekeeping is digging it out - {0} more trips to go.", "客房部正在挖它——还要跑 {0} 趟。" },
        { "STOP CLEARING - the trips already walked are wasted", "停止清理 —— 已经跑过的趟数就白费了" },
        { "CLEAR IT OUT - free, {0} housekeeping trips", "清理出来 —— 不花钱，客房部跑 {0} 趟" },
        { "START - ${0}, {1} materials, shut {2} days", "开工 —— ${0}，{1} 份材料，关房 {2} 天" },
        { "BROKEN FURNITURE", "家具坏了" },
        { "Nothing broken in here after all.", "这里其实没有坏的东西。" },
        ...
        { "Building work in progress.", "正在施工。" },
        { "SAVES", "存档" },
        { "SLOT {0}", "{0} 号槽" },
        { "SAVE HERE", "存到这里" },
        { "OVERWRITE", "覆盖" },
